import type { TempGroup } from '@/features/WeatherMood/components/Weather/constants/recommend';

import type { WeatherMain } from '@/types/api/weather';

import { TEMP_BOUNDARY } from '@/features/WeatherMood/components/Weather/constants/recommend';
import { fallbackMenus } from '@/features/WeatherMood/components/Weather/constants/recommend';
import { tempMenus } from '@/features/WeatherMood/components/Weather/constants/recommend';
import { weatherMenus } from '@/features/WeatherMood/components/Weather/constants/recommend';
import { MIN_RECOMMEND_COUNT } from '@/features/WeatherMood/components/Weather/constants/recommend';

import { pickRandomUnique } from '@/features/WeatherMood/utils/shuffle';
