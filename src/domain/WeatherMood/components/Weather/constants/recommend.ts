...
export const weatherMenus: Record<WeatherMain, string[]> = {
  ...
  Clouds: ['우동', '라멘', '파스타', '피자', '김치찌개', '잡채'],

  Rain: ['김치찌개', '순두부찌개', '우동', '짬뽕', '부침류 대체 → 잡채'],

  Drizzle: ['우동', '라멘', '만두', '잡채', '떡국'],

  Thunderstorm: ['떡볶이', '마라두부', '깐풍기', '닭강정', '짬뽕'],

  Snow: ['떡국', '순두부찌개', '김치찌개', '우동', '라멘', '리조또'],
  ...
  Sand: ['삼겹살', '불고기', '동파육', '탕수육', '피자'],

  Smoke: ['불고기', '삼겹살', '순두부찌개', '김치찌개', '라멘'],
